 ...
 */
package sdu.mdsd.math.interpreter.services;
...
@Singleton
public class MathInterpreterGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	
	public class MathExpElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "sdu.mdsd.math.interpreter.MathInterpreter.MathExp");
	...
	public class ExpElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "sdu.mdsd.math.interpreter.MathInterpreter.Exp");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class FactorElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "sdu.mdsd.math.interpreter.MathInterpreter.Factor");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cLeftAssignment_0 = (Assignment)cGroup.eContents().get(0);
	...
	public class PrimaryElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "sdu.mdsd.math.interpreter.MathInterpreter.Primary");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class ParenthesisElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "sdu.mdsd.math.interpreter.MathInterpreter.Parenthesis");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class NumberElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "sdu.mdsd.math.interpreter.MathInterpreter.Number");
	...
	private final FactorOpElements pFactorOp;
	...
	public MathInterpreterGrammarAccess(GrammarProvider grammarProvider,
		...
		this.pFactorOp = new FactorOpElements();
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("sdu.mdsd.math.interpreter.MathInterpreter".equals(grammar.getName())) {
				return grammar;
			}
	...
	//FactorOp:
	//	{Mult} '*' | {Div} '/';
	public FactorOpElements getFactorOpAccess() {
		return pFactorOp;
	}
	
	public ParserRule getFactorOpRule() {
