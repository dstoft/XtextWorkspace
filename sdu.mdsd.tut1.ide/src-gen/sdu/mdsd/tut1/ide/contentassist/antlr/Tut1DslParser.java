 ...
 */
package sdu.mdsd.tut1.ide.contentassist.antlr;
...
import sdu.mdsd.tut1.ide.contentassist.antlr.internal.InternalTut1DslParser;
import sdu.mdsd.tut1.services.Tut1DslGrammarAccess;

public class Tut1DslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(Tut1DslGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, Tut1DslGrammarAccess grammarAccess) {
	...
	@Override
	protected InternalTut1DslParser createParser() {
		InternalTut1DslParser result = new InternalTut1DslParser(null);
